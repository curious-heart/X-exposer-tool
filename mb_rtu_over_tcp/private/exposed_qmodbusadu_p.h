/*
 * This file is copied from Qt source file: qmodbusadu_p.h
 *
 * We exposed it here for custom use.
 *
*/

#ifndef EXPOSED_QMODBUSADU_P_H
#define EXPOSED_QMODBUSADU_P_H
